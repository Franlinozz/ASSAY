...
export const STANDARD_MARKDOWN: string =
...
export const TOOLS: ToolDoc[] = [
  ...
  },
  {
    ...
    title: 'Story bank',
    description:
      'Build 2–4 STAR interview stories, each grounded in a confirmed claim. Price: 0.2 USDT (x402 on X Layer, eip155:196). Example: {dossierId:"dsr_…"} → cited stories + tribunal grade. Proof promise: every story traces to evidence; thin air is refused.',
    priceUsdt: 0.2,
    args: [
      {
        name: 'dossierId',
  ...
  },
  {
    ...
    title: 'Tailor résumé',
    description:
      'Rewrite résumé achievement bullets against a target JD, evidence-constrained and format-law clean. Price: 0.3 USDT (x402 on X Layer, eip155:196). Example: {claims:[…], jd:"…"} → tailored bullets + tribunal grade. Proof promise: no bullet renders without a confirmed claim behind it.',
    priceUsdt: 0.3,
    args: [
      {
        name: 'dossierId',
