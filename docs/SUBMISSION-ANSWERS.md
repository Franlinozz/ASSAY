...
`https://github.com/Franlinozz/ASSAY`. The repository is itself a verifiable exhibit: **339 passing
tests** (284 Vitest, 51 Playwright, 4 Foundry), clean-checkout CI, a published security model,
