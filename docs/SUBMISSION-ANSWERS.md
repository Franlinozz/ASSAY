...
`https://github.com/Franlinozz/ASSAY`. The repository is itself a verifiable exhibit: **345 passing
tests** (288 Vitest, 53 Playwright, 4 Foundry), clean-checkout CI, a published security model,
