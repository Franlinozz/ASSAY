...
[![Tests](https://img.shields.io/badge/tests-345_passing-2FA96B)](https://github.com/Franlinozz/ASSAY/actions/workflows/ci.yml)
...
The release gate runs **345 tests**: **288 Vitest + 53 Playwright end-to-end + 4 Foundry**. It also
