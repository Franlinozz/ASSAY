...
[![Tests](https://img.shields.io/badge/tests-370_passing-2FA96B)](https://github.com/Franlinozz/ASSAY/actions/workflows/ci.yml)
...
The release gate runs **370 tests**: **309 Vitest + 57 Playwright end-to-end + 4 Foundry**. It also
