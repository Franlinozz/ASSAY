...
[![Tests](https://img.shields.io/badge/tests-374_passing-2FA96B)](https://github.com/Franlinozz/ASSAY/actions/workflows/ci.yml)
...
The release gate runs **374 tests**: **313 Vitest + 57 Playwright end-to-end + 4 Foundry**. It also
