...
[![Tests](https://img.shields.io/badge/tests-380_passing-2FA96B)](https://github.com/Franlinozz/ASSAY/actions/workflows/ci.yml)
...
The release gate runs **380 tests**: **319 Vitest + 57 Playwright end-to-end + 4 Foundry**. It also
